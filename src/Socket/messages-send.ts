...
export const makeMessagesSocket = (config: SocketConfig) => {
	...
	const getButtonArgs = (message: proto.IMessage): BinaryNode => {
		...
		if (
			...
			firstButtonName &&
			data[firstButtonName as keyof typeof data]
		) {
			const name = data[firstButtonName as keyof typeof data]
			return {
				tag: 'biz',
				attrs: {},
				content: [
		...
		const baseAttrs: {
			...
			content: Array<object | BinaryNode> | undefined
		} = {
			tag: 'biz',
			attrs: {},
			content: undefined
		...
		if (
			...
			return baseAttrs as BinaryNode
		}
