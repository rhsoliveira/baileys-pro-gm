...
export type ListButtonsTypes = Buttonable & Templatable & Interactiveable & Cardsable & Shopable & PaymentOrder & PaymentRequestMessage & OrderChangeStatus;
export type AnyMediaMessageContent = (({
    image: WAMediaUpload;
    caption?: string;
    jpegThumbnail?: string;
} & Mentionable & Contextable & ListButtonsTypes & WithDimensions) | ({
    video: WAMediaUpload;
    caption?: string;
    gifPlayback?: boolean;
    jpegThumbnail?: string;
...
export type OrderChangeStatus = {
    orderChangeStatus?: {
        status: WAPaymentOrderStatusEnum;
        referenceId: string;
    };
};
export type PaymentRequestMessage = {
    orderPaymentChangeStatus?: {
...
} & Mentionable & Buttonable & Templatable & Interactiveable & Shopable & Contextable & Listable & PaymentRequest & PaymentOrder & Editable) | AnyMediaMessageContent | {
    event: EventMessageOptions;
} | ({
    poll: PollMessageOptions;
} & Mentionable & Contextable & Buttonable & Templatable & Interactiveable & Shopable & PaymentRequest & Editable) | {
    contacts: {
        displayName?: string;
...
export declare enum WAWebInteractiveMessagesNativeFlowNameEnum {
...
export declare enum WAPixTypes {
    CPF = "CPF",
    CNPJ = "CNPJ",
    EMAIL = "EMAIL",
    RANDOM = "EVP",
...
export declare enum WAPaymentSettingsTypeEnum {
    BOLETO = "boleto",
    CARDS = "cards",
...
export declare enum WAPaymentStatusEnum {
    CAPTURED = "captured",
    PENDING = "pending"
}
export declare enum WAPaymentOrderStatusEnum {
    PENDING = "pending",
...
export declare enum WAProductOrderTypeEnum {
    DIGITAL_GOODS = "digital-goods",
    PHYSICAL_GOODS = "physical-goods",
    ANY = "any",
    NONE = "none"
}
export declare enum WAInteractiveMessagesNativeFlowName {
