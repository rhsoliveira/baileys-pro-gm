...
import { WAInteractiveMessagesNativeFlowName, WAWebInteractiveMessagesNativeFlowNameEnum } from '../Types/index.js';
...
export const makeMessagesSocket = (config) => {
    ...
    const getButtonArgs = (message) => {
        ...
        const data = {
            [WAWebInteractiveMessagesNativeFlowNameEnum.REVIEW_AND_PAY]: 'order_details',
            [WAWebInteractiveMessagesNativeFlowNameEnum.REVIEW_ORDER]: 'order_status',
        ...
        if (message?.interactiveMessage?.nativeFlowMessage?.buttons?.[0]?.name ===
            WAInteractiveMessagesNativeFlowName.PAYMENT_INFO) {
            baseAttrs.content = [
                {
                    tag: 'interactive',
                    attrs: {
                    ...
                    content: [
                        {
                            ...
                            attrs: {
                                v: '2',
                                name: WAInteractiveMessagesNativeFlowName.MIXED
                            }
                        }
                    ]
                }
